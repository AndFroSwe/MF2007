...
typedef struct {
  ...
  real_T Motorviscousfriction;         /* '<S8>/Motor viscous friction' */
  real_T Switch_j;                     /* '<S8>/Switch' */
  real_T LoadInertiaaftergear;         /* '<S8>/Load Inertia after gear' */
  real_T Add_g;                        /* '<S8>/Add' */
  real_T n;                            /* '<S6>/n' */
  real_T n2;                           /* '<S6>/1//n2' */
  real_T n_m;                          /* '<S6>/1//n' */
...
struct P_motor_io_T_ {
  ...
  real_T UnitDelay_InitialCondition;   /* Expression: 0
                                        ...
                                        */
  real_T J_Gain;                       /* Expression: 1/motor.J
 ...
 * '<S7>'   : 'motor_io/Model Motor/Dc motor with friction/DC motor model'
 * '<S8>'   : 'motor_io/Model Motor/Dc motor with friction/Inertia and resistance model '
 * '<S9>'   : 'motor_io/Model Motor/Dc motor with friction/Motor'
 * '<S10>'  : 'motor_io/Model Motor/Dc motor with friction/Inertia and resistance model /Karnop friction1'
 * '<S11>'  : 'motor_io/Model Motor/Dc motor with friction/Inertia and resistance model /Karnop friction1/Velocity threshold '
 * '<S12>'  : 'motor_io/PWM/DS1104BIT_OUT_C0'
 * '<S13>'  : 'motor_io/PWM/DS1104SL_DSP_PWM'
 * '<S14>'  : 'motor_io/RTI Data/RTI Data Store'
 * '<S15>'  : 'motor_io/RTI Data/RTI Data Store/RTI Data Store'
 * '<S16>'  : 'motor_io/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 * '<S17>'  : 'motor_io/enc I//F/DS1104ENC_POS_C1'
 * '<S18>'  : 'motor_io/enc I//F/DS1104ENC_SETUP'
 * '<S19>'  : 'motor_io/enc I//F/DS1104ENC_SET_POS_C1'
 */
