...
void motor_io_output(void)
{
  ...
  /* Sum: '<S7>/Add1' */
  motor_io_B.Add1 = motor_io_B.kR - motor_io_B.UnitDelay;
   ...
   *  Constant: '<S10>/Couloumb friction'
   */
  ...
  /* Gain: '<S8>/Load Inertia after gear' */
  motor_io_B.LoadInertiaaftergear = motor_io_P.LoadInertiaaftergear_Gain *
    motor_io_B.J;

  /* Sum: '<S8>/Add' */
  motor_io_B.Add_g = motor_io_B.LoadInertiaaftergear + motor_io_B.Switch_j;
  if (rtmIsMajorTimeStep(motor_io_M)) {
    /* Gain: '<S6>/n' */
    motor_io_B.n = motor_io_P.n * 0.0;

    /* Gain: '<S6>/1//n2' */
    motor_io_B.n2 = motor_io_P.n2_Gain * 0.0;
  }

  /* Gain: '<S6>/1//n' */
  motor_io_B.n_m = motor_io_P.n_Gain * motor_io_B.Integrator;

  /* Gain: '<S6>/1//n1' */
  motor_io_B.n1 = motor_io_P.n1_Gain * motor_io_B.J;
  if (rtmIsMajorTimeStep(motor_io_M)) {
...
void motor_io_update(void)
{
  if (rtmIsMajorTimeStep(motor_io_M)) {
    ...
    motor_io_DW.UnitDelay_DSTATE = motor_io_B.Add_g;
  }
...
RT_MODEL_motor_io_T *motor_io(void)
{
  ...
  motor_io_M->Sizes.numBlocks = (53);  /* Number of blocks */
  motor_io_M->Sizes.numBlockIO = (35); /* Number of block outputs */
  motor_io_M->Sizes.numBlockPrms = (31);/* Sum of parameter "widths" */
  return motor_io_M;
}
