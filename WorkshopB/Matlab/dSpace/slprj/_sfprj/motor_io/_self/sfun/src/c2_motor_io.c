...
static void initialize_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance);
static void initialize_params_c2_motor_io(SFc2_motor_ioInstanceStruct
  *chartInstance);
static void enable_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance);
static void disable_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_motor_io(SFc2_motor_ioInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_motor_io(SFc2_motor_ioInstanceStruct
  *chartInstance);
static void set_sim_state_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance);
static void sf_gateway_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance);
static void mdl_start_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance);
static void c2_chartstep_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance);
static void initSimStructsc2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_olderPIDVolt, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_oldPIDVolt, const char_T *c2_identifier);
static real_T c2_d_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_olderErr, const char_T *c2_identifier);
static real_T c2_f_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_g_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_oldErr, const char_T *c2_identifier);
static real_T c2_h_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_i_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_rs, const char_T *c2_identifier);
static real_T c2_j_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_k_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_oldPos, const char_T *c2_identifier);
static real_T c2_l_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_m_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_oldVel, const char_T *c2_identifier);
static real_T c2_n_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_o_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_oldAcc, const char_T *c2_identifier);
static real_T c2_p_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_i_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_q_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_time, const char_T *c2_identifier);
static real_T c2_r_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_i_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_j_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_s_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_err, const char_T *c2_identifier);
static real_T c2_t_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static real_T c2_sqrt(SFc2_motor_ioInstanceStruct *chartInstance, real_T c2_x);
static void c2_eml_error(SFc2_motor_ioInstanceStruct *chartInstance);
static const mxArray *c2_k_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_u_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_k_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_v_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_motor_io, const char_T *c2_identifier);
static uint8_T c2_w_emlrt_marshallIn(SFc2_motor_ioInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_motor_ioInstanceStruct *chartInstance, real_T *c2_x);
static void init_dsm_address_info(SFc2_motor_ioInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_motor_ioInstanceStruct *chartInstance);
...
static void initialize_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_motor_io = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_p_hoistedGlobal = chartInstance->c2_is_active_c2_motor_io;
  ...
  const mxArray *c2_st)
{
  ...
  *chartInstance->c2_voltFollowing = c2_s_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c2_is_active_c2_motor_io = c2_v_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 15)), "is_active_c2_motor_io");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_motor_io(chartInstance);
...
static void sf_gateway_c2_motor_io(SFc2_motor_ioInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_motor_io(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u;
  const mxArray *c2_y = NULL;
  SFc2_motor_ioInstanceStruct *chartInstance;
  chartInstance = (SFc2_motor_ioInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_motor_io_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_motor_io, const char_T *c2_identifier)
{
  ...
  c2_y = c2_w_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_motor_io), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_motor_io);
  return c2_y;
}
...
void sf_c2_motor_io_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4208914944U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(572493562U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4045179940U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3829352152U);
}

mxArray* sf_c2_motor_io_get_post_codegen_info(void);
mxArray *sf_c2_motor_io_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_motor_io_get_post_codegen_info();
...
mxArray *sf_c2_motor_io_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_motor_io_jit_fallback_info(void)
{
...
mxArray *sf_c2_motor_io_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_motor_io(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x6'type','srcId','name','auxInfo'{{M[4],M[0],T\"oldVel\",S'l','i','p'{{M1x2[257 263],M[0],}}},{M[4],M[0],T\"olderErr\",S'l','i','p'{{M1x2[1757 1765],M[0],}}},{M[4],M[0],T\"olderPIDVolt\",S'l','i','p'{{M1x2[1887 1899],M[0],}}},{M[4],M[0],T\"rs\",S'l','i','p'{{M1x2[374 376],M[0],}}},{M[4],M[0],T\"time\",S'l','i','p'{{M1x2[145 149],M[0],}}},{M[8],M[0],T\"is_active_c2_motor_io\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 16, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_motor_io_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_motor_ioInstanceStruct *) chartInfo->chartInstance;
...
{
  return "v8xdfLf10uKCAGgXurjxvD";
}

static void sf_opaque_initialize_c2_motor_io(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_motor_ioInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_motor_io((SFc2_motor_ioInstanceStruct*) chartInstanceVar);
  initialize_c2_motor_io((SFc2_motor_ioInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_motor_io(void *chartInstanceVar)
{
  enable_c2_motor_io((SFc2_motor_ioInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_motor_io(void *chartInstanceVar)
{
  disable_c2_motor_io((SFc2_motor_ioInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_motor_io(void *chartInstanceVar)
{
  sf_gateway_c2_motor_io((SFc2_motor_ioInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_motor_io(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_motor_io((SFc2_motor_ioInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_motor_io(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_motor_io((SFc2_motor_ioInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_motor_io(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_motor_ioInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_motor_io((SFc2_motor_ioInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_motor_io((SFc2_motor_ioInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_motor_io(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_motor_io((SFc2_motor_ioInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_motor_io(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1472635128U));
  ssSetChecksum1(S,(3146254146U));
  ssSetChecksum2(S,(2542198152U));
  ssSetChecksum3(S,(502734018U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_motor_io(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_motor_io(SimStruct *S)
{
  SFc2_motor_ioInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_motor_ioInstanceStruct *)utMalloc(sizeof
    (SFc2_motor_ioInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_motor_ioInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_motor_io;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_motor_io;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_motor_io;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_motor_io;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_motor_io;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_motor_io;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_motor_io;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_motor_io;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_motor_io;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_motor_io;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_motor_io;
...
void c2_motor_io_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_motor_io(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_motor_io(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_motor_io(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_motor_io_method_dispatcher.\n"
