...
static void initialize_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance);
static void initialize_params_c3_motor_io(SFc3_motor_ioInstanceStruct
  *chartInstance);
static void enable_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance);
static void disable_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_motor_io(SFc3_motor_ioInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_motor_io(SFc3_motor_ioInstanceStruct
  *chartInstance);
static void set_sim_state_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_st);
static void finalize_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance);
static void sf_gateway_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance);
static void mdl_start_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance);
static void c3_chartstep_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance);
static void initSimStructsc3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_olderPIDVolt, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_oldPIDVolt, const char_T *c3_identifier);
static real_T c3_d_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_e_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_olderErr, const char_T *c3_identifier);
static real_T c3_f_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_g_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_oldErr, const char_T *c3_identifier);
static real_T c3_h_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_i_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_rs, const char_T *c3_identifier);
static real_T c3_j_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_f_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_k_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_oldPos, const char_T *c3_identifier);
static real_T c3_l_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_g_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_m_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_oldVel, const char_T *c3_identifier);
static real_T c3_n_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_h_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_o_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_oldAcc, const char_T *c3_identifier);
static real_T c3_p_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_i_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_q_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_time, const char_T *c3_identifier);
static real_T c3_r_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_j_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_s_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_err, const char_T *c3_identifier);
static real_T c3_t_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static real_T c3_sqrt(SFc3_motor_ioInstanceStruct *chartInstance, real_T c3_x);
static void c3_eml_error(SFc3_motor_ioInstanceStruct *chartInstance);
static const mxArray *c3_k_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_u_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_k_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_v_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_motor_io, const char_T *c3_identifier);
static uint8_T c3_w_emlrt_marshallIn(SFc3_motor_ioInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sqrt(SFc3_motor_ioInstanceStruct *chartInstance, real_T *c3_x);
static void init_dsm_address_info(SFc3_motor_ioInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc3_motor_ioInstanceStruct *chartInstance);
...
static void initialize_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_motor_io = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_p_hoistedGlobal = chartInstance->c3_is_active_c3_motor_io;
  ...
  const mxArray *c3_st)
{
  ...
  *chartInstance->c3_voltFollowing = c3_s_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c3_is_active_c3_motor_io = c3_v_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 15)), "is_active_c3_motor_io");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_motor_io(chartInstance);
...
static void sf_gateway_c3_motor_io(SFc3_motor_ioInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_motor_io(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u;
  const mxArray *c3_y = NULL;
  SFc3_motor_ioInstanceStruct *chartInstance;
  chartInstance = (SFc3_motor_ioInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_motor_io_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c3_b_is_active_c3_motor_io, const char_T *c3_identifier)
{
  ...
  c3_y = c3_w_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_motor_io), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_motor_io);
  return c3_y;
}
...
void sf_c3_motor_io_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_motor_io_get_post_codegen_info(void);
mxArray *sf_c3_motor_io_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_motor_io_get_post_codegen_info();
...
mxArray *sf_c3_motor_io_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_motor_io_jit_fallback_info(void)
{
...
mxArray *sf_c3_motor_io_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_motor_io(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x6'type','srcId','name','auxInfo'{{M[4],M[0],T\"oldVel\",S'l','i','p'{{M1x2[257 263],M[0],}}},{M[4],M[0],T\"olderErr\",S'l','i','p'{{M1x2[1805 1813],M[0],}}},{M[4],M[0],T\"olderPIDVolt\",S'l','i','p'{{M1x2[1935 1947],M[0],}}},{M[4],M[0],T\"rs\",S'l','i','p'{{M1x2[374 376],M[0],}}},{M[4],M[0],T\"time\",S'l','i','p'{{M1x2[145 149],M[0],}}},{M[8],M[0],T\"is_active_c3_motor_io\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 16, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_motor_io_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_motor_ioInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c3_motor_io(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_motor_ioInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c3_motor_io((SFc3_motor_ioInstanceStruct*) chartInstanceVar);
  initialize_c3_motor_io((SFc3_motor_ioInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_motor_io(void *chartInstanceVar)
{
  enable_c3_motor_io((SFc3_motor_ioInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_motor_io(void *chartInstanceVar)
{
  disable_c3_motor_io((SFc3_motor_ioInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_motor_io(void *chartInstanceVar)
{
  sf_gateway_c3_motor_io((SFc3_motor_ioInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_motor_io(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_motor_io((SFc3_motor_ioInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_motor_io(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_motor_io((SFc3_motor_ioInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_motor_io(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_motor_ioInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_motor_io((SFc3_motor_ioInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_motor_io((SFc3_motor_ioInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_motor_io(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_motor_io((SFc3_motor_ioInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_motor_io(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_motor_io(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_motor_io(SimStruct *S)
{
  SFc3_motor_ioInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_motor_ioInstanceStruct *)utMalloc(sizeof
    (SFc3_motor_ioInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_motor_ioInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_motor_io;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_motor_io;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_motor_io;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_motor_io;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_motor_io;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_motor_io;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_motor_io;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_motor_io;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_motor_io;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_motor_io;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_motor_io;
...
void c3_motor_io_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_motor_io(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_motor_io(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_motor_io(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_motor_io_method_dispatcher.\n"
