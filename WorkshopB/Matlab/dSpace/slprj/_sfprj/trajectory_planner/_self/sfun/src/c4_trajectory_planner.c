...
#include "c4_trajectory_planner.h"
...
static const char * c4_debug_family_names[44] = { "Ts", "vmax", "amax", "amin",
  "rs", "t1", "t2", "t3", "voltmax", "out1", "out2", "out3", "out4", "J1",
  "motor_j", "n", "motor_k", "motor_R", "motor_d", "accPart", "velPartK",
  "velPartD", "s2", "s1", "s0", "r0", "PIDVolt", "nargin", "nargout", "feedback",
  "acceleration", "velocity", "position", "voltFollowing", "volt", "err", "time",
  "oldAcc", "oldVel", "oldPos", "oldErr", "olderErr", "oldPIDVolt",
  "olderPIDVolt" };

/* Function Declarations */
static void initialize_c4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance);
static void initialize_params_c4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance);
static void enable_c4_trajectory_planner(SFc4_trajectory_plannerInstanceStruct
  *chartInstance);
static void disable_c4_trajectory_planner(SFc4_trajectory_plannerInstanceStruct *
  chartInstance);
static void c4_update_debugger_state_c4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance);
static void set_sim_state_c4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_trajectory_planner(SFc4_trajectory_plannerInstanceStruct
  *chartInstance);
static void sf_gateway_c4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance);
static void mdl_start_c4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance);
static void c4_chartstep_c4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance);
static void initSimStructsc4_trajectory_planner
  (SFc4_trajectory_plannerInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_olderPIDVolt, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_oldPIDVolt, const char_T *c4_identifier);
static real_T c4_d_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_e_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_olderErr, const char_T *c4_identifier);
static real_T c4_f_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_g_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_oldErr, const char_T *c4_identifier);
static real_T c4_h_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_i_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_oldPos, const char_T *c4_identifier);
static real_T c4_j_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_k_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_oldVel, const char_T *c4_identifier);
static real_T c4_l_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_g_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_m_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_oldAcc, const char_T *c4_identifier);
static real_T c4_n_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_h_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_o_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_time, const char_T *c4_identifier);
static real_T c4_p_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_i_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_q_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_err, const char_T *c4_identifier);
static real_T c4_r_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static void c4_eml_error(SFc4_trajectory_plannerInstanceStruct *chartInstance);
static const mxArray *c4_j_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_s_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_j_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_t_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_trajectory_planner, const
  char_T *c4_identifier);
static uint8_T c4_u_emlrt_marshallIn(SFc4_trajectory_plannerInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_trajectory_plannerInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc4_trajectory_plannerInstanceStruct
  *chartInstance);
  ...
  (SFc4_trajectory_plannerInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_trajectory_planner = 0U;
}
  ...
  (SFc4_trajectory_plannerInstanceStruct *chartInstance)
{
  ...
  c4_o_hoistedGlobal = chartInstance->c4_is_active_c4_trajectory_planner;
  ...
  (SFc4_trajectory_plannerInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *chartInstance->c4_voltFollowing = c4_q_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c4_is_active_c4_trajectory_planner = c4_t_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 14)),
     "is_active_c4_trajectory_planner");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_trajectory_planner(chartInstance);
  ...
  (SFc4_trajectory_plannerInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_trajectory_planner(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_trajectory_plannerMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_acceleration, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_velocity, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_position, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_voltFollowing, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_volt, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_feedback, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_err, 6U);
}
  ...
  (SFc4_trajectory_plannerInstanceStruct *chartInstance)
{
  ...
  uint32_T c4_debug_family_var_map[44];
  real_T c4_Ts;
  real_T c4_vmax;
  real_T c4_amax;
  real_T c4_amin;
  ...
  c4_hoistedGlobal = *chartInstance->c4_feedback;
  c4_b_feedback = c4_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 44U, 44U, c4_debug_family_names,
    c4_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_Ts, 0U, c4_i_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_vmax, 1U, c4_i_sf_marshallOut,
    c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_amax, 2U, c4_i_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_amin, 3U, c4_i_sf_marshallOut,
    c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_rs, 4U, c4_i_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 28U, c4_i_sf_marshallOut,
    c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_feedback, 29U, c4_i_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_acceleration, 30U,
    c4_i_sf_marshallOut, c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_velocity, 31U, c4_i_sf_marshallOut,
    c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_position, 32U, c4_i_sf_marshallOut,
    c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_voltFollowing, 33U,
    c4_i_sf_marshallOut, c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_volt, 34U, c4_i_sf_marshallOut,
    c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_err, 35U, c4_i_sf_marshallOut,
    c4_i_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c4_time, 36U,
    c4_h_sf_marshallOut, c4_h_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c4_oldAcc, 37U,
    c4_g_sf_marshallOut, c4_g_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c4_oldVel, 38U,
    c4_f_sf_marshallOut, c4_f_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c4_oldPos, 39U,
    c4_e_sf_marshallOut, c4_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c4_oldErr, 40U,
    c4_d_sf_marshallOut, c4_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c4_olderErr, 41U,
    c4_c_sf_marshallOut, c4_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c4_oldPIDVolt, 42U,
    c4_b_sf_marshallOut, c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c4_olderPIDVolt, 43U,
  ...
  if (CV_EML_IF(0, 1, 4, CV_RELATIONAL_EVAL(4U, 0U, 0, chartInstance->c4_time,
  ...
  c4_b_hoistedGlobal = chartInstance->c4_oldVel;
  c4_c_hoistedGlobal = chartInstance->c4_oldAcc;
  c4_A = 0.01 * (c4_b_acceleration + c4_c_hoistedGlobal);
  c4_b_x = c4_A;
  c4_c_x = c4_b_x;
  c4_d_x = c4_c_x;
  c4_y = c4_d_x / 2.0;
  c4_b_velocity = c4_b_hoistedGlobal + c4_y;
  ...
  c4_d_hoistedGlobal = chartInstance->c4_oldPos;
  c4_e_hoistedGlobal = chartInstance->c4_oldVel;
  c4_b_A = 0.01 * (c4_b_velocity + c4_e_hoistedGlobal);
  c4_e_x = c4_b_A;
  c4_f_x = c4_e_x;
  c4_g_x = c4_f_x;
  c4_b_y = c4_g_x / 2.0;
  c4_b_position = c4_d_hoistedGlobal + c4_b_y;
  ...
  c4_c_A = (c4_accPart + c4_velPartD) * 112.0;
  c4_h_x = c4_c_A;
  c4_i_x = c4_h_x;
  c4_j_x = c4_i_x;
  c4_c_y = c4_j_x / 0.0697;
  c4_b_voltFollowing = c4_c_y + c4_velPartK;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 96);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 97);
  if (CV_EML_IF(0, 1, 7, !chartInstance->c4_oldErr_not_empty)) {
  ...
  if (CV_EML_IF(0, 1, 8, !chartInstance->c4_olderErr_not_empty)) {
  ...
  if (CV_EML_IF(0, 1, 9, !chartInstance->c4_oldPIDVolt_not_empty)) {
  ...
  if (CV_EML_IF(0, 1, 10, !chartInstance->c4_olderPIDVolt_not_empty)) {
  ...
  if (CV_EML_IF(0, 1, 11, CV_RELATIONAL_EVAL(4U, 0U, 3, c4_b_volt, c4_voltmax,
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_trajectory_plannerInstanceStruct *chartInstance;
  chartInstance = (SFc4_trajectory_plannerInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_trajectory_planner_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_u_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_trajectory_planner), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_trajectory_planner);
  return c4_y;
}
...
void sf_c4_trajectory_planner_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3729958463U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3099103890U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1714999018U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4263651113U);
}

mxArray* sf_c4_trajectory_planner_get_post_codegen_info(void);
mxArray *sf_c4_trajectory_planner_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("1EkNsbrBARyjrxYJJGxqfG");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_trajectory_planner_get_post_codegen_info();
...
mxArray *sf_c4_trajectory_planner_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_trajectory_planner_jit_fallback_info(void)
{
...
mxArray *sf_c4_trajectory_planner_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_trajectory_planner(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[13],T\"acceleration\",},{M[1],M[17],T\"err\",},{M[1],M[15],T\"position\",},{M[1],M[14],T\"velocity\",},{M[1],M[9],T\"volt\",},{M[1],M[16],T\"voltFollowing\",},{M[4],M[0],T\"oldAcc\",S'l','i','p'{{M1x2[186 192],M[0],}}},{M[4],M[0],T\"oldErr\",S'l','i','p'{{M1x2[1455 1461],M[0],}}},{M[4],M[0],T\"oldPIDVolt\",S'l','i','p'{{M1x2[1573 1583],M[0],}}},{M[4],M[0],T\"oldPos\",S'l','i','p'{{M1x2[304 310],M[0],}}}}",
    "100 S1x5'type','srcId','name','auxInfo'{{M[4],M[0],T\"oldVel\",S'l','i','p'{{M1x2[245 251],M[0],}}},{M[4],M[0],T\"olderErr\",S'l','i','p'{{M1x2[1512 1520],M[0],}}},{M[4],M[0],T\"olderPIDVolt\",S'l','i','p'{{M1x2[1642 1654],M[0],}}},{M[4],M[0],T\"time\",S'l','i','p'{{M1x2[133 137],M[0],}}},{M[8],M[0],T\"is_active_c4_trajectory_planner\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 15, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_trajectory_planner_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_trajectory_plannerInstanceStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,2,0,1,"acceleration");
          _SFD_SET_DATA_PROPS(1,2,0,1,"velocity");
          _SFD_SET_DATA_PROPS(2,2,0,1,"position");
          _SFD_SET_DATA_PROPS(3,2,0,1,"voltFollowing");
          _SFD_SET_DATA_PROPS(4,2,0,1,"volt");
          _SFD_SET_DATA_PROPS(5,1,1,0,"feedback");
          _SFD_SET_DATA_PROPS(6,2,0,1,"err");
        ...
        _SFD_CV_INIT_EML(0,1,1,13,0,0,0,0,0,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2121);
        _SFD_CV_INIT_EML_IF(0,1,0,139,155,-1,173);
        _SFD_CV_INIT_EML_IF(0,1,1,194,212,-1,232);
        _SFD_CV_INIT_EML_IF(0,1,2,253,271,-1,291);
        _SFD_CV_INIT_EML_IF(0,1,3,312,330,-1,350);
        _SFD_CV_INIT_EML_IF(0,1,4,613,627,-1,648);
        _SFD_CV_INIT_EML_IF(0,1,5,685,699,-1,720);
        _SFD_CV_INIT_EML_IF(0,1,6,752,766,-1,787);
        _SFD_CV_INIT_EML_IF(0,1,7,1462,1480,-1,1500);
        _SFD_CV_INIT_EML_IF(0,1,8,1521,1541,-1,1561);
        _SFD_CV_INIT_EML_IF(0,1,9,1584,1606,-1,1630);
        _SFD_CV_INIT_EML_IF(0,1,10,1655,1679,-1,1705);
        _SFD_CV_INIT_EML_IF(0,1,11,2008,2027,2048,2072);
        _SFD_CV_INIT_EML_IF(0,1,12,2048,2072,-1,2072);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,616,626,-1,5);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,688,698,-1,5);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,755,765,-1,5);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,3,2011,2026,-1,5);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,4,2055,2071,-1,3);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(6,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c4_i_sf_marshallOut,(MexInFcnForType)c4_i_sf_marshallIn);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c4_acceleration);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c4_velocity);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c4_position);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c4_voltFollowing);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c4_volt);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c4_feedback);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c4_err);
      }
    } else {
...
{
  return "DHHC35jHpH0gDSB6hzxuPB";
}

static void sf_opaque_initialize_c4_trajectory_planner(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_trajectory_plannerInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_trajectory_planner((SFc4_trajectory_plannerInstanceStruct*)
    chartInstanceVar);
  initialize_c4_trajectory_planner((SFc4_trajectory_plannerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_trajectory_planner(void *chartInstanceVar)
{
  enable_c4_trajectory_planner((SFc4_trajectory_plannerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_trajectory_planner(void *chartInstanceVar)
{
  disable_c4_trajectory_planner((SFc4_trajectory_plannerInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_trajectory_planner(void *chartInstanceVar)
{
  sf_gateway_c4_trajectory_planner((SFc4_trajectory_plannerInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_trajectory_planner(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_trajectory_planner
    ((SFc4_trajectory_plannerInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_trajectory_planner(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_trajectory_planner((SFc4_trajectory_plannerInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c4_trajectory_planner(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_trajectory_plannerInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_trajectory_planner((SFc4_trajectory_plannerInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_trajectory_planner((SFc4_trajectory_plannerInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_trajectory_planner(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_trajectory_planner
      ((SFc4_trajectory_plannerInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_trajectory_planner(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2854082010U));
  ssSetChecksum1(S,(1430603963U));
  ssSetChecksum2(S,(460941961U));
  ssSetChecksum3(S,(3258473331U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_trajectory_planner(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_trajectory_planner(SimStruct *S)
{
  SFc4_trajectory_plannerInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_trajectory_plannerInstanceStruct *)utMalloc(sizeof
    (SFc4_trajectory_plannerInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_trajectory_plannerInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_trajectory_planner;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_trajectory_planner;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_trajectory_planner;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_trajectory_planner;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_trajectory_planner;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_trajectory_planner;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_trajectory_planner;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_trajectory_planner;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_trajectory_planner;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_trajectory_planner;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_trajectory_planner;
...
void c4_trajectory_planner_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_trajectory_planner(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_trajectory_planner(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_trajectory_planner(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_trajectory_planner_method_dispatcher.\n"
