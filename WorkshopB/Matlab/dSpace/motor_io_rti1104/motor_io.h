...
/* Block signals for system '<Root>/Traject_and_Model_function 1' */
typedef struct {
  real_T acceleration;                 /* '<Root>/Traject_and_Model_function 1' */
  real_T velocity;                     /* '<Root>/Traject_and_Model_function 1' */
  real_T position;                     /* '<Root>/Traject_and_Model_function 1' */
  real_T voltFollowing;                /* '<Root>/Traject_and_Model_function 1' */
  real_T volt;                         /* '<Root>/Traject_and_Model_function 1' */
  real_T err;                          /* '<Root>/Traject_and_Model_function 1' */
} B_Traject_and_Model_function1_T;

/* Block states (auto storage) for system '<Root>/Traject_and_Model_function 1' */
typedef struct {
  real_T time;                         /* '<Root>/Traject_and_Model_function 1' */
  real_T oldVel;                       /* '<Root>/Traject_and_Model_function 1' */
  real_T oldPos;                       /* '<Root>/Traject_and_Model_function 1' */
  real_T rs;                           /* '<Root>/Traject_and_Model_function 1' */
  real_T oldErr;                       /* '<Root>/Traject_and_Model_function 1' */
  real_T olderErr;                     /* '<Root>/Traject_and_Model_function 1' */
  real_T oldPIDVolt;                   /* '<Root>/Traject_and_Model_function 1' */
  real_T olderPIDVolt;                 /* '<Root>/Traject_and_Model_function 1' */
} DW_Traject_and_Model_function_T;
...
typedef struct {
  ...
  B_Traject_and_Model_function1_T sf_Traject_and_Model_function3;/* '<Root>/Traject_and_Model_function 3' */
  B_Traject_and_Model_function1_T sf_Traject_and_Model_function1;/* '<Root>/Traject_and_Model_function 1' */
} B_motor_io_T;
...
typedef struct {
  ...
  DW_Traject_and_Model_function_T sf_Traject_and_Model_function3;/* '<Root>/Traject_and_Model_function 3' */
  DW_Traject_and_Model_function_T sf_Traject_and_Model_function1;/* '<Root>/Traject_and_Model_function 1' */
} DW_motor_io_T;
...
struct P_motor_io_T_ {
  ...
  real_T Resetenc_Value;               /* Expression: 0
                                        * Referenced by: '<Root>/Reset enc'
                                        */
  real_T RS_Value;                     /* Expression: 0
                                        * Referenced by: '<Root>/RS'
                                        */
  ...
  real_T w1_scaling_Gain;              /* Expression: 2*pi/(1000)/Ts
                                        ...
                                        */
  real_T Resetenc_Value_k;             /* Expression: 0
 ...
 * '<S4>'   : 'motor_io/Traject_and_Model_function 1'
 * '<S5>'   : 'motor_io/Traject_and_Model_function 3'
 * '<S6>'   : 'motor_io/enc I//F'
 * '<S7>'   : 'motor_io/DC motor/Karnop friction1'
 * '<S8>'   : 'motor_io/DC motor/Karnop friction1/Velocity threshold '
