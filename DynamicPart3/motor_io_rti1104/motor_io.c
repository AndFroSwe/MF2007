...
void motor_io_output(void)
{
  ...
  if (rtmIsMajorTimeStep(motor_io_M)) {
    ...
    /* S-Function (rti_commonblock): '<S12>/S-Function3' */
    /* This comment workarounds a code generation problem */

    /* S-Function (rti_commonblock): '<S12>/S-Function4' */
    /* This comment workarounds a code generation problem */
  ...
  motor_io_B.x1i = motor_io_X.Integrator_CSTATE;

  /* Gain: '<S8>/Current constant' */
  motor_io_B.Currentconstant = motor_io_P.Currentconstant_Gain * motor_io_B.x1i;

  /* Saturate: '<S9>/Saturate to Fc' */
  temp = motor_io_B.Currentconstant;
  ...
  /* End of Saturate: '<S9>/Saturate to Fc' */

  /* Integrator: '<S8>/Integrator1' */
  motor_io_B.Angularvelocity = motor_io_X.Integrator1_CSTATE;

  /* Abs: '<S9>/Abs' */
  motor_io_B.Abs = fabs(motor_io_B.Angularvelocity);
  ...
  /* Gain: '<S9>/Vicous friction' */
  motor_io_B.Vicousfriction = motor_io_P.Vicousfriction_Gain *
    motor_io_B.Angularvelocity;

  /* Signum: '<S9>/Sign' */
  temp = motor_io_B.Angularvelocity;
  if (temp < 0.0) {
    motor_io_B.Sign = -1.0;
  } else if (temp > 0.0) {
    motor_io_B.Sign = 1.0;
  ...
  /* Gain: '<S7>/Motor viscous friction' */
  motor_io_B.Motorviscousfriction = motor_io_P.Motorviscousfriction_Gain *
    motor_io_B.Angularvelocity;

  /* Switch: '<S7>/Switch' incorporates:
   *  Constant: '<S7>/Enable Karnop'
   */
  if (motor_io_P.enable_karnop > motor_io_P.Switch_Threshold) {
    motor_io_B.Switch_j = motor_io_B.Friction;
  } else {
    motor_io_B.Switch_j = motor_io_B.Motorviscousfriction;
  }

  /* End of Switch: '<S7>/Switch' */
  if (rtmIsMajorTimeStep(motor_io_M)) {
    /* UnitDelay: '<S5>/Unit Delay' */
    motor_io_B.UnitDelay = motor_io_DW.UnitDelay_DSTATE;
  }

  /* Sum: '<S8>/Supplied current and ext M ' */
  motor_io_B.SuppliedcurrentandextM = motor_io_B.Currentconstant -
    motor_io_B.UnitDelay;

  /* Gain: '<S8>/Inertia of motor' */
  motor_io_B.Angacc = motor_io_P.Inertiaofmotor_Gain *
    motor_io_B.SuppliedcurrentandextM;

  /* Gain: '<S7>/Load Inertia after gear' */
  motor_io_B.LoadInertiaaftergear = motor_io_P.LoadInertiaaftergear_Gain *
    motor_io_B.Angacc;

  /* Sum: '<S7>/Add' */
  motor_io_B.Add = motor_io_B.LoadInertiaaftergear + motor_io_B.Switch_j;
  if (rtmIsMajorTimeStep(motor_io_M)) {
  }

  /* Gain: '<S8>/Gain3' */
  motor_io_B.Gain3 = motor_io_P.Gain3_Gain * motor_io_B.Angularvelocity;

  /* Gain: '<S8>/Resistance in motor' */
  motor_io_B.Resistanceinmotor = motor_io_P.Resistanceinmotor_Gain *
    motor_io_B.x1i;

  /* Sum: '<S8>/Add' */
  motor_io_B.Add_b = (motor_io_B.Switch - motor_io_B.Gain3) -
    motor_io_B.Resistanceinmotor;

  /* Gain: '<S8>/Inductance in motor' */
  motor_io_B.i_dot = motor_io_P.Inductanceinmotor_Gain * motor_io_B.Add_b;

  /* Integrator: '<S8>/Integrator2' */
  motor_io_B.Position = motor_io_X.Integrator2_CSTATE;

  /* Gain: '<S6>/n' */
  motor_io_B.n = motor_io_P.n * motor_io_B.Currentconstant;

  /* Gain: '<S6>/1//n2' */
  motor_io_B.n2 = motor_io_P.n2_Gain * motor_io_B.Position;

  /* Gain: '<S6>/1//n' */
  motor_io_B.n_m = motor_io_P.n_Gain * motor_io_B.Angularvelocity;

  /* Gain: '<S6>/1//n1' */
  motor_io_B.n1 = motor_io_P.n1_Gain * motor_io_B.Angacc;
  if (rtmIsMajorTimeStep(motor_io_M)) {
...
void motor_io_update(void)
{
  if (rtmIsMajorTimeStep(motor_io_M)) {
    ...
    motor_io_DW.UnitDelay_DSTATE = motor_io_B.Add;
  }
...
void motor_io_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = motor_io_B.i_dot;

  /* Derivatives for Integrator: '<S8>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = motor_io_B.Angacc;

  /* Derivatives for Integrator: '<S8>/Integrator2' */
  _rtXdot->Integrator2_CSTATE = motor_io_B.Angularvelocity;
}

/* Model initialize function */
void motor_io_initialize(void)
{
  /* Start for S-Function (rti_commonblock): '<S12>/S-Function1' */
  ...
  motor_io_DW.UnitDelay_DSTATE = motor_io_P.UnitDelay_InitialCondition;

  /* InitializeConditions for Integrator: '<S8>/Integrator2' */
  motor_io_X.Integrator2_CSTATE = motor_io_P.Integrator2_IC;
}
...
RT_MODEL_motor_io_T *motor_io(void)
{
...

  {
    ...
    motor_io_B.Sum = 0.0;
    motor_io_B.x1i = 0.0;
    motor_io_B.Currentconstant = 0.0;
    motor_io_B.Stickslipregion = 0.0;
    motor_io_B.Angularvelocity = 0.0;
    motor_io_B.Abs = 0.0;
    ...
    motor_io_B.Switch_j = 0.0;
    motor_io_B.UnitDelay = 0.0;
    motor_io_B.SuppliedcurrentandextM = 0.0;
    motor_io_B.Angacc = 0.0;
    motor_io_B.LoadInertiaaftergear = 0.0;
    motor_io_B.Add = 0.0;
    motor_io_B.Gain3 = 0.0;
    motor_io_B.Resistanceinmotor = 0.0;
    motor_io_B.Add_b = 0.0;
    motor_io_B.i_dot = 0.0;
    motor_io_B.Position = 0.0;
    motor_io_B.n = 0.0;
    motor_io_B.n2 = 0.0;
    motor_io_B.n_m = 0.0;
    motor_io_B.n1 = 0.0;
  ...
  motor_io_DW.UnitDelay_DSTATE = 0.0;
  ...
  /* Initialize Sizes */
  motor_io_M->Sizes.numContStates = (3);/* Number of continuous states */
  ...
  motor_io_M->Sizes.numBlocks = (56);  /* Number of blocks */
  motor_io_M->Sizes.numBlockIO = (38); /* Number of block outputs */
  motor_io_M->Sizes.numBlockPrms = (34);/* Sum of parameter "widths" */
  return motor_io_M;
}
