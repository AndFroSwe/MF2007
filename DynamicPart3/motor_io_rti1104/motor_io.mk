...
#
#  $RCSfile: motor_io.mk $ $Revision: 2.71 $ $Date: 2014/07/09 11:55:48MESZ $
...
COMPUTER                       = PCWIN
MODEL                          = motor_io
MODULES                        = motor_io_data.c motor_io_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
	"$(START_DIR)\motor_io_rti1104" \
	"$(START_DIR)" \
	"C:\Users\gabras\Desktop\Workshop1"
