...
\begin{document}
\maketitle
http://www.hemnet.se/bostad/villa-7rum-segerstad-karlstads-kommun-karra-310-8630315
\section*{Parameter identification}
This section covers the methods behind finding the parameters to enter into the
model to get the biggest similarity to the physical plant.http://www.hemnet.se/bostad/villa-7rum-segerstad-karlstads-kommun-karra-310-8630315
...
the stick slip zone.  There is now one more design paameter that needs
...
\begin{equation}
    \label{eq:phi}
    \Phi = e^{AT_s}
\end{equation}http://www.hemnet.se/bostad/villa-7rum-segerstad-karlstads-kommun-karra-310-8630315
and 
\begin{equation}
    \label{eq:gamma}
