...
#define RTB_STRUCTURE_NAME             motor_io_B
#define RTP_STRUCTURE_NAME             motor_io_P
...
{
  /* Calls for base sample time: [0.036424631028033456, 0] */
  ...
  motor_io_B.SFunction2 = (real_T) ds1104_inc_delta_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);
}
