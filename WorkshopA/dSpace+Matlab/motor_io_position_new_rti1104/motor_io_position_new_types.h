 ...
 */
#ifndef RTW_HEADER_motor_io_position_new_types_h_
#define RTW_HEADER_motor_io_position_new_types_h_
#include "rtwtypes.h"
...
typedef struct P_motor_io_position_new_T_ P_motor_io_position_new_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_motor_io_position_new_T RT_MODEL_motor_io_position_ne_T;

#endif                                 /* RTW_HEADER_motor_io_position_new_types_h_ */
