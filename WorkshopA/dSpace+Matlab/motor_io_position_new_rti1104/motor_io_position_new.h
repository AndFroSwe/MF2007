 ...
 */
#ifndef RTW_HEADER_motor_io_position_new_h_
#define RTW_HEADER_motor_io_position_new_h_
#include <math.h>
#include <string.h>
#ifndef motor_io_position_new_COMMON_INCLUDES_
# define motor_io_position_new_COMMON_INCLUDES_
#include <brtenv.h>
#include <rtkernel.h>
...
#endif                                 /* motor_io_position_new_COMMON_INCLUDES_ */

#include "motor_io_position_new_types.h"
...
#define motor_io_position_new_rtModel  RT_MODEL_motor_io_position_ne_T
...
=======
  ...
  real_T Gff;                          /* '<S2>/Gff' */
  real_T Ipart1;                       /* '<S2>/I part1' */
  real_T Sum1;                         /* '<S2>/Sum1' */
  real_T Ipart;                        /* '<S2>/I part' */
  real_T SFunction1;                   /* '<S15>/S-Function1' */
  real_T fi1_scaling;                  /* '<S7>/fi1_scaling' */
  real_T PDpart;                       /* '<S2>/PD part' */
  real_T Sum;                          /* '<S2>/Sum' */
  real_T Sum2;                         /* '<S2>/Sum2' */
  real_T VoltageSaturation;            /* '<S2>/Voltage Saturation ' */
  real_T Gain;                         /* '<Root>/Gain' */
  real_T Volt;                         /* '<S4>/Saturation' */
  real_T pwm_skalning;                 /* '<S4>/pwm_skalning' */
  real_T Sum_f;                        /* '<S4>/Sum' */
  real_T Gff_e;                        /* '<S1>/Gff' */
  real_T Ipart1_d;                     /* '<S1>/I part1' */
  real_T Sum1_e;                       /* '<S1>/Sum1' */
  real_T Ipart_a;                      /* '<S1>/I part' */
  real_T Integrator1;                  /* '<S3>/Integrator1' */
  real_T Quantizer;                    /* '<S6>/Quantizer' */
  real_T ZeroOrderHold;                /* '<S6>/Zero-Order Hold' */
  real_T PDpart_k;                     /* '<S1>/PD part' */
  real_T Sum_e;                        /* '<S1>/Sum' */
  real_T Sum2_n;                       /* '<S1>/Sum2' */
...
>>>>>>> 698b95201d3ae24de2fb5ff3e6658cdd38e5f1ec
  ...
  real_T Gain2_n;                      /* '<S2>/Gain2' */
  real_T Sum4_b;                       /* '<S2>/Sum4' */
...
=======
  ...
  real_T PDpart_states;                /* '<S2>/PD part' */
  real_T Gff_states_d;                 /* '<S1>/Gff' */
  real_T Ipart1_states_o;              /* '<S1>/I part1' */
  real_T Ipart_states_f;               /* '<S1>/I part' */
  real_T PDpart_states_j;              /* '<S1>/PD part' */
  real_T Gff1_states[2];               /* '<S1>/Gff1' */
  real_T Gff2_states[2];               /* '<S1>/Gff2' */
  real_T Gff1_states_n[2];             /* '<S2>/Gff1' */
  real_T Gff2_states_b[2];             /* '<S2>/Gff2' */
  real_T Gff_tmp;                      /* '<S2>/Gff' */
  real_T PDpart_tmp;                   /* '<S2>/PD part' */
  real_T Gff_tmp_k;                    /* '<S1>/Gff' */
  real_T PDpart_tmp_m;                 /* '<S1>/PD part' */
  real_T Gff1_tmp;                     /* '<S1>/Gff1' */
  real_T Gff2_tmp;                     /* '<S1>/Gff2' */
  real_T Gff1_tmp_o;                   /* '<S2>/Gff1' */
  real_T Gff2_tmp_k;                   /* '<S2>/Gff2' */
...
#define rtB                            motor_io_position_new_B
#define BlockIO                        B_motor_io_position_new_T
#define rtX                            motor_io_position_new_X
#define ContinuousStates               X_motor_io_position_new_T
#define rtXdot                         motor_io_position_new_XDot
#define StateDerivatives               XDot_motor_io_position_new_T
#define tXdis                          motor_io_position_new_XDis
#define StateDisabled                  XDis_motor_io_position_new_T
#define rtP                            motor_io_position_new_P
#define Parameters                     P_motor_io_position_new_T
#define rtDWork                        motor_io_position_new_DW
#define D_Work                         DW_motor_io_position_new_T
#define rtPrevZCSigState               motor_io_position_new_PrevZCX
...
=======
  ...
  real_T Enable1_Off0_On_Value;        /* Expression: 1
                                        ...
                                        */
  real_T Gff_NumCoef_k[2];             /* Expression: [d1_ d0_]
                                        * Referenced by: '<S1>/Gff'
                                        */
  real_T Gff_DenCoef_h[2];             /* Expression: [1 r0]
                                        * Referenced by: '<S1>/Gff'
                                        */
  real_T Gff_InitialStates_e;          /* Expression: 0
                                        * Referenced by: '<S1>/Gff'
                                        */
  real_T Ipart1_NumCoef_o[2];          /* Expression: [0 1]
                                        * Referenced by: '<S1>/I part1'
                                        */
  real_T Ipart1_DenCoef_n[2];          /* Expression: [1 -1]
                                        * Referenced by: '<S1>/I part1'
                                        */
  real_T Ipart1_InitialStates_h;       /* Expression: 0
                                        * Referenced by: '<S1>/I part1'
                                        */
  real_T Ipart_NumCoef_f[2];           /* Expression: [0 1]
                                        * Referenced by: '<S1>/I part'
                                        */
  real_T Ipart_DenCoef_n[2];           /* Expression: [1 -1]
                                        * Referenced by: '<S1>/I part'
                                        */
  real_T Ipart_InitialStates_f;        /* Expression: 0
                                        * Referenced by: '<S1>/I part'
                                        */
  real_T Integrator1_IC;               /* Expression: 0
                                        * Referenced by: '<S3>/Integrator1'
                                        */
  real_T PDpart_NumCoef_o[2];          /* Expression: [d1 d0]
                                        * Referenced by: '<S1>/PD part'
                                        */
  real_T PDpart_DenCoef_h[2];          /* Expression: [1 r0]
                                        * Referenced by: '<S1>/PD part'
                                        */
  real_T PDpart_InitialStates_h;       /* Expression: 0
                                        * Referenced by: '<S1>/PD part'
                                        */
  real_T VoltageSaturation_UpperSat_g; /* Expression: 24
                                        * Referenced by: '<S1>/Voltage Saturation '
                                        */
  real_T VoltageSaturation_LowerSat_h; /* Expression: -24
                                        * Referenced by: '<S1>/Voltage Saturation '
                                        */
  real_T Gff1_InitialStates;           /* Expression: 0
                                        * Referenced by: '<S1>/Gff1'
...
extern P_motor_io_position_new_T motor_io_position_new_P;

/* Block signals (auto storage) */
extern B_motor_io_position_new_T motor_io_position_new_B;

/* Continuous states (auto storage) */
extern X_motor_io_position_new_T motor_io_position_new_X;

/* Block states (auto storage) */
extern DW_motor_io_position_new_T motor_io_position_new_DW;

/* External data declarations for dependent source files */

/* Zero-crossing (trigger) state */
extern PrevZCX_motor_io_position_new_T motor_io_position_new_PrevZCX;

/* Model entry point functions */
extern void motor_io_position_new_initialize(void);
extern void motor_io_position_new_output(void);
extern void motor_io_position_new_update(void);
extern void motor_io_position_new_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern motor_io_position_new_rtModel *motor_io_position_new(void);
...
extern RT_MODEL_motor_io_position_ne_T *const motor_io_position_new_M;
 ...
 * '<S6>'   : 'motor_io_position_new/Sensor 1'
 * '<S7>'   : 'motor_io_position_new/enc I//F'
 * '<S8>'   : 'motor_io_position_new/DC motor/Karnop friction1'
 * '<S9>'   : 'motor_io_position_new/DC motor/Karnop friction1/Velocity threshold '
 * '<S10>'  : 'motor_io_position_new/PWM/DS1104BIT_OUT_C0'
 * '<S11>'  : 'motor_io_position_new/PWM/DS1104SL_DSP_PWM'
 * '<S12>'  : 'motor_io_position_new/RTI Data/RTI Data Store'
 * '<S13>'  : 'motor_io_position_new/RTI Data/RTI Data Store/RTI Data Store'
 * '<S14>'  : 'motor_io_position_new/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
