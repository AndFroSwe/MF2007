/************************ dSPACE target specific file *************************
   ...
   Include file .\motor_io_position_new_rti1104\motor_io_position_new_th.c :
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\motor_io_position_new_rti1104\motor_io_position_new_th.c is for ST).
# endif
