...
#
#  $RCSfile: motor_io_position.mk $ $Revision: 2.71 $ $Date: 2014/07/09 11:55:48MESZ $
...
COMPUTER                       = PCWIN
MODEL                          = motor_io_position
MODULES                        = motor_io_position_data.c motor_io_position_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = motor_io_positionlib.lib
...
RTWCUST_INCLUDES = \
	"$(START_DIR)\motor_io_position_rti1104" \
	"$(START_DIR)"
