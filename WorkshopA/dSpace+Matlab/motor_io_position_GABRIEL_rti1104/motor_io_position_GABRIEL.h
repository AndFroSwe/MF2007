 ...
 */
#ifndef RTW_HEADER_motor_io_position_GABRIEL_h_
#define RTW_HEADER_motor_io_position_GABRIEL_h_
#include <math.h>
#include <string.h>
#ifndef motor_io_position_GABRIEL_COMMON_INCLUDES_
# define motor_io_position_GABRIEL_COMMON_INCLUDES_
#include <brtenv.h>
#include <rtkernel.h>
...
#endif                                 /* motor_io_position_GABRIEL_COMMON_INCLUDES_ */

#include "motor_io_position_GABRIEL_types.h"
...
#define motor_io_position_GABRIEL_rtModel RT_MODEL_motor_io_position_GA_T
...
} X_motor_io_position_GABRIEL_T;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator1_CSTATE;           /* '<S3>/Integrator1' */
  real_T Integrator_CSTATE;            /* '<S3>/Integrator' */
} XDot_motor_io_position_GABRIE_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator1_CSTATE;        /* '<S3>/Integrator1' */
  boolean_T Integrator_CSTATE;         /* '<S3>/Integrator' */
} XDis_motor_io_position_GABRIE_T;
...
#define rtB                            motor_io_position_GABRIEL_B
#define BlockIO                        B_motor_io_position_GABRIEL_T
#define rtX                            motor_io_position_GABRIEL_X
#define ContinuousStates               X_motor_io_position_GABRIEL_T
#define rtXdot                         motor_io_position_GABRIEL_XDot
#define StateDerivatives               XDot_motor_io_position_GABRIE_T
#define tXdis                          motor_io_position_GABRIEL_XDis
#define StateDisabled                  XDis_motor_io_position_GABRIE_T
#define rtP                            motor_io_position_GABRIEL_P
#define Parameters                     P_motor_io_position_GABRIEL_T
#define rtDWork                        motor_io_position_GABRIEL_DW
#define D_Work                         DW_motor_io_position_GABRIEL_T
#define rtPrevZCSigState               motor_io_position_GABRI_PrevZCX
#define PrevZCSigStates                PrevZCX_motor_io_position_GAB_T
...
struct tag_RTM_motor_io_position_GAB_T {
  const char_T *path;
...
extern P_motor_io_position_GABRIEL_T motor_io_position_GABRIEL_P;

/* Block signals (auto storage) */
extern B_motor_io_position_GABRIEL_T motor_io_position_GABRIEL_B;

/* Continuous states (auto storage) */
extern X_motor_io_position_GABRIEL_T motor_io_position_GABRIEL_X;

/* Block states (auto storage) */
extern DW_motor_io_position_GABRIEL_T motor_io_position_GABRIEL_DW;

/* External data declarations for dependent source files */

/* Zero-crossing (trigger) state */
extern PrevZCX_motor_io_position_GAB_T motor_io_position_GABRI_PrevZCX;

/* Model entry point functions */
extern void motor_io_position_GABRIEL_initialize(void);
extern void motor_io_position_GABRIEL_output(void);
extern void motor_io_position_GABRIEL_update(void);
extern void motor_io_position_GABRIEL_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern motor_io_position_GABRIEL_rtModel *motor_io_position_GABRIEL(void);
...
extern RT_MODEL_motor_io_position_GA_T *const motor_io_position_GABRIEL_M;
