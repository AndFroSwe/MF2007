...
#
#  $RCSfile: motor_io_position_GABRIEL.mk $ $Revision: 2.71 $ $Date: 2014/07/09 11:55:48MESZ $
...
MAKEFILE                       = motor_io_position_GABRIEL.mk
...
COMPUTER                       = PCWIN
MODEL                          = motor_io_position_GABRIEL
MODULES                        = motor_io_position_GABRIEL_data.c motor_io_position_GABRIEL_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = C:\Users\adamlang\Documents\MF2007\WorkshopA\dSpace+Matlab
# Shared library for utility code
RTW_SHARED_LIB_SRCS_WILD       = 
RTW_SHARED_LIB_SRCS_DIR        = 
RTW_SHARED_LIB_OBJS_DIR        = 
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = motor_io_position_GABRIELlib.lib
...
RTWCUST_INCLUDES = \
	"$(START_DIR)\motor_io_position_GABRIEL_rti1104" \
	"$(START_DIR)"
