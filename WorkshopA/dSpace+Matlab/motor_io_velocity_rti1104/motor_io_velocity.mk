...
#
#  $RCSfile: motor_io_velocity.mk $ $Revision: 2.71 $ $Date: 2014/07/09 11:55:48MESZ $
...
COMPUTER                       = PCWIN
MODEL                          = motor_io_velocity
MODULES                        = motor_io_velocity_data.c motor_io_velocity_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = motor_io_velocitylib.lib
...
RTWCUST_INCLUDES = \
	"$(START_DIR)\motor_io_velocity_rti1104" \
	"$(START_DIR)"
