/*********************** dSPACE target specific file *************************
   ...
   Include file motor_io_velocity_rti.c:
...
#define RTB_STRUCTURE_NAME             motor_io_velocity_B
#define RTP_STRUCTURE_NAME             motor_io_velocity_P
...
{
  /* Calls for base sample time: [0.021970064966318436, 0] */
  ...
  motor_io_velocity_B.SFunction2 = (real_T) ds1104_inc_delta_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);
}
