/*********************** dSPACE target specific file *************************
   ...
   Include file motor_io_position_new_2_rti.c:
...
#define RTB_STRUCTURE_NAME             motor_io_position_new_2_B
#define RTP_STRUCTURE_NAME             motor_io_position_new_2_P
...
{
  /* Calls for base sample time: [0.017951958020513102, 0] */
  /* dSPACE I/O Board DS1104 #1 Unit:ENC_POS Group:POS */
  motor_io_position_new_2_B.SFunction1 = (real_T) ds1104_inc_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);

  /* dSPACE I/O Board DS1104 #1 Unit:ENC_POS Group:DPOS */
  motor_io_position_new_2_B.SFunction2 = (real_T) ds1104_inc_delta_position_read
    (1, DS1104_INC_LINE_SUBDIV_4);
}
