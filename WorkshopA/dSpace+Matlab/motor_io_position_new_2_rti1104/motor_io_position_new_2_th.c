/************************ dSPACE target specific file *************************
   ...
   Include file .\motor_io_position_new_2_rti1104\motor_io_position_new_2_th.c :

   Task Configuration file for model : motor_io_position_new_2

   RTI1104 7.3 (02-Nov-2014)/2.6
   07-Apr-2016 00:29:48
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   Timer Task 1 [0.017952 0] s    : Timer A interrupt
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\motor_io_position_new_2_rti1104\motor_io_position_new_2_th.c is for ST).
# endif
...
/* Initialize dynamically generated services */
  ...
  rtith_bind_interrupt( /* --- Bind interrupt to task. ----- */
      ...
      pTask1,             /*  Task (TCB pointer).              */
      (0.0179519580205131 * RTI_TIMER_TASK_TIME_SCALE),             /*  Sample time or period.           */
      C_LOCAL,             /*  RTK channel.                     */
