function runtlccmd
% RUNTLCCMD - run tlc command (regenerate C code from .rtw file) for model motor_io_position_new_2
% This function will run the tlc command stored in the variable 
% "tlccmd" in tlccmd.mat, whose contents is as follows:
% 
% 	tlc
% 	-r
% 	C:\Users\adamlang\Documents\MF2007\WorkshopA\dSpace+Matlab\motor_io_position_new_2_rti1104\motor_io_position_new_2.rtw
% 	C:\Program Files (x86)\dSPACE RCPHIL 2014-B\MATLAB\RTI\RTI1104\TLC\rti1104.tlc
% 	-OC:\Users\adamlang\Documents\MF2007\WorkshopA\dSpace+Matlab\motor_io_position_new_2_rti1104
...
% 	-IC:\Users\adamlang\Documents\MF2007\WorkshopA\dSpace+Matlab\motor_io_position_new_2_rti1104\tlc
...
% 	-p10000
   ...
   if ~sysopen
      ...
      rtwprivate('rtwattic', 'setBuildDir', 'C:\Users\adamlang\Documents\MF2007\WorkshopA\dSpace+Matlab\motor_io_position_new_2_rti1104');
      rtwprivate('ec_set_replacement_flag', 'motor_io_position_new_2');
      set_param('motor_io_position_new_2', 'RTWGenSharedUtilitiesWithoutAssert', 0);
      load tlccmd.mat;
      savedpwd = pwd;
      cd ..;
      ...
      set_param('motor_io_position_new_2', 'RTWGenSharedUtilitiesWithoutAssert', -1);
      cd(savedpwd);
